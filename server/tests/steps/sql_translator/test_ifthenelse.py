...
def test_simple_condition_integer_postgres(query):
    step = IfthenelseStep(
        **{
            'name': 'ifthenelse',
            'if': {
...
def test_simple_condition_strings_postgres(query):
    step = IfthenelseStep(
        **{
            'name': 'ifthenelse',
            'if': {
...
def test_or_condition_postgres(query):
    step = IfthenelseStep(
        **{
            'name': 'ifthenelse',
            'if': {
...
def test_then_should_support_nested_else_postgres(query):
    step = IfthenelseStep(
        **{
            'name': 'ifthenelse',
            'newColumn': 'cond1',
